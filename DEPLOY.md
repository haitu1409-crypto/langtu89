...
3. **Cấu hình Project:**
   - **Project Name**: Đặt tên là `langtu89`
...
4. **Deploy:**
   - Click "Deploy"
   - Vercel sẽ tự động deploy và tạo URL: `https://langtu89.vercel.app`
...
3. **Deploy:**
   ...
   vercel
   ```
   - Khi được hỏi project name, nhập: `langtu89`
...
- Tên miền sẽ là: `https://langtu89.vercel.app`
