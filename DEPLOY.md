...
3. **Cấu hình Project:**
   - **Project Name**: Đặt tên là `satthumienbac`
...
4. **Deploy:**
   - Click "Deploy"
   - Vercel sẽ tự động deploy và tạo URL: `https://satthumienbac.vercel.app`
...
3. **Deploy:**
   ...
   vercel
   ```
   - Khi được hỏi project name, nhập: `satthumienbac`
...
- Tên miền sẽ là: `https://satthumienbac.vercel.app`
