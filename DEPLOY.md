...
3. **Cấu hình Project:**
   - **Project Name**: Đặt tên là `hoanglong188lux`
...
4. **Deploy:**
   - Click "Deploy"
   - Vercel sẽ tự động deploy và tạo URL: `https://hoanglong188lux.vercel.app`
...
3. **Deploy:**
   ...
   vercel
   ```
   - Khi được hỏi project name, nhập: `hoanglong188lux`
...
- Tên miền sẽ là: `https://hoanglong188lux.vercel.app`
